...
!read and write lattice parameters
      ...
      read(3,*),atom_I,atom_II,atom_III,atom_IIII
      read(3,*),natom_I,natom_II,natom_III,natom_IIII

      print*,"test"
      write(40,'(4(2x,A4))'),atom_I,atom_II,atom_III,atom_IIII
      write(40,*),"    1.00000000"
      write(40,'(3(2x,f14.10))'),a_x,a_y,a_z
      write(40,'(3(2x,f14.10))'),b_x,b_y,b_z
      write(40,'(3(2x,f14.10))'),c_x,c_y,c_z
      write(40,'(4(2x,A4))'),atom_I,atom_II,atom_III,atom_IIII
      write(40,'(4(2x,I4))'),natom_I,natom_II,natom_III,natom_IIII

!converte to fractional coordinates
      read(3,'()')
!fix the atoms with z between z_min and z_min
      natom = natom_I + natom_II + natom_III + natom_IIII
      do i=1,natom
         read(3,*),x(i),y(i),z(i)

      program main
      implicit none
      character*2 atom_I,atom_II,atom_III,elem1
      ...
      integer natom,i
      integer natom_I,natom_II,natom_III
...
!read and write lattice parameters
      ...
      read(3,*),atom_I,atom_II,atom_III
      read(3,*),natom_I,natom_II,natom_III

      print*,"test"
      write(40,'(3(2x,A4))'),atom_I,atom_II,atom_III
      write(40,*),"    1.00000000"
      write(40,'(3(2x,f14.10))'),a_x,a_y,a_z
      write(40,'(3(2x,f14.10))'),b_x,b_y,b_z
      write(40,'(3(2x,f14.10))'),c_x,c_y,c_z
      write(40,'(3(2x,A4))'),atom_I,atom_II,atom_III
      write(40,'(3(2x,I4))'),natom_I,natom_II,natom_III

!converte to fractional coordinates
      read(3,'()')
!fix the atoms with z between z_min and z_min
      natom = natom_I + natom_II + natom_III
      do i=1,natom
         read(3,*),x(i),y(i),z(i)
